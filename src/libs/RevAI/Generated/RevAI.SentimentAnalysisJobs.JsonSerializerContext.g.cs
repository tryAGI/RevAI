...
namespace RevAI
{
    ...
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::System.DateTime?))]
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(double?))]
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::RevAI.TranscriptElementType?), TypeInfoPropertyName = "NullableTranscriptElementType2")]
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::RevAI.SentimentAnalysisJobStatus?), TypeInfoPropertyName = "NullableSentimentAnalysisJobStatus2")]
    ...
    internal sealed partial class SentimentAnalysisJobsSourceGenerationContextChunk0 : global::System.Text.Json.Serialization.JsonSerializerContext
    {
    }
    /// <summary>
    ///
    /// </summary>
    public sealed partial class SentimentAnalysisJobsSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static SentimentAnalysisJobsSourceGenerationContext Default { get; } = new(DefaultOptions);

        private SentimentAnalysisJobsSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
        ...
        {
            options.Converters.Add(new global::RevAI.JsonConverters.UnixTimestampJsonConverter());
        ...
        private sealed class LazyEnumJsonConverterFactory : global::System.Text.Json.Serialization.JsonConverterFactory
        {
            ...
            {
                return
                    typeToConvert == typeof(global::RevAI.TranscriptElementType)

                    || typeToConvert == typeof(global::RevAI.TranscriptElementType?)

                    || typeToConvert == typeof(global::RevAI.SentimentAnalysisJobStatus)
            ...
            {
                if (typeToConvert == typeof(global::RevAI.TranscriptElementType))
                {
                    return new global::RevAI.JsonConverters.TranscriptElementTypeJsonConverter();
                }

                if (typeToConvert == typeof(global::RevAI.TranscriptElementType?))
                {
                    return new global::RevAI.JsonConverters.TranscriptElementTypeNullableJsonConverter();
                }

                if (typeToConvert == typeof(global::RevAI.SentimentAnalysisJobStatus))
                {
                    return new global::RevAI.JsonConverters.SentimentAnalysisJobStatusJsonConverter();
                }

                if (typeToConvert == typeof(global::RevAI.SentimentAnalysisJobStatus?))
                {
                    return new global::RevAI.JsonConverters.SentimentAnalysisJobStatusNullableJsonConverter();
                }
        ...
        private sealed class LazyChunkResolver : global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver
        {
            ...
            private static global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver CreateResolver(int index)
            {
                return index switch
                {
                    0 => new SentimentAnalysisJobsSourceGenerationContextChunk0(new global::System.Text.Json.JsonSerializerOptions()),
