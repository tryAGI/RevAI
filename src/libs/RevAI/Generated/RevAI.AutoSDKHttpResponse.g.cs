...
namespace RevAI
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::RevAI.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::RevAI.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::RevAI.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::RevAI.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::RevAI.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::RevAI.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::RevAI.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::RevAI.ApiException exception)
        ...
        private static global::RevAI.AutoSDKRequestOptions CloneRequestOptions(
            global::RevAI.AutoSDKRequestOptions? source)
        {
            var clone = new global::RevAI.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
