...
namespace RevAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::RevAI.AutoSDKRetryOptions Retry { get; set; } = new global::RevAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::RevAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::RevAI.IAutoSDKHook>();
        ...
        public global::RevAI.AutoSDKClientOptions AddHook(
            global::RevAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::RevAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::RevAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::RevAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::RevAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::RevAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::RevAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::RevAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::RevAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::RevAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::RevAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::RevAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::RevAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::RevAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::RevAI.AutoSDKRetryOptions? Retry { get; set; }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::RevAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::RevAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::RevAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    internal static class AutoSDKRequestOptionsSupport
    {
        internal static global::RevAI.AutoSDKHookContext CreateHookContext(
            ...
            global::RevAI.AutoSDKClientOptions clientOptions,
            global::RevAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::RevAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::RevAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::RevAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::RevAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::RevAI.IAutoSDKHook, global::RevAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::RevAI.AutoSDKHookContext context)
        {
