...
namespace RevAI
{
    public partial interface ITranscriptionJobsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::RevAI.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::RevAI.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::RevAI.TranscriptionJob>>> GetListOfTranscriptionJobsAsResponseAsync(
            int? limit = default,
            string? startingAfter = default,
            global::RevAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
