...
namespace RevAI
{
    ...
    public sealed partial class TranscriptElement
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RevAI.JsonConverters.TranscriptElementTypeJsonConverter))]
        public global::RevAI.TranscriptElementType? Type { get; set; }
        ...
        public TranscriptElement(
            global::RevAI.TranscriptElementType? type,
            string? value,
            double? ts,
            double? endTs,
            double? confidence)
